...
float RoutePlanner::CalculateHValue(RouteModel::Node const *node) {
    return node->distance(*(end_node)); //add in a single sentence 270ms vs 97ms
    //return h;(this->end_node))
}
...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
    ...
    RouteModel::Node* neighbour = nullptr;
...
RouteModel::Node *RoutePlanner::NextNode() {
    ...
    std::sort(open_list.begin(), open_list.end(), [](const RouteModel::Node* N1, const RouteModel::Node* N2 ) -> bool
    {
